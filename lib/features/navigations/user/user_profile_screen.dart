...
//
// class _UserProfileScreenState extends State<UserProfileScreen> {
//   late final Future<Map<String,dynamic>?> _userProfile;
//
//   @override
//   void initState() {
//     super.initState();
//     _userProfile = ProfileAPIService(context:context).getUserProfileUpdate();
//   }
//
//   @override
//   Widget build(BuildContext context) {
...
//
//                                         profileInfoCard(
//                                             icon: user['gender'] != null && user['gender'].toString().toLowerCase() == 'female' ? Iconsax.woman :Iconsax.man,
//                                             label: 'Gender',
...
//                                           padding: EdgeInsets.symmetric(horizontal: 12.0,vertical: 4),
//                                           decoration: BoxDecoration(
//                                               color: user['status'] != null && user['status'].toString().toLowerCase() == 'active'? Colors.green.withValues(alpha: 0.7):Colors.red.withValues(alpha: 0.7),
//                                               borderRadius: BorderRadius.circular(20)
//                                           ),
//                                           child: Text(user['status']??'N/A',style: TextStyle(color: Colors.white),),
//                                         ),
//                                         IconButton(onPressed: (){
//                                           navigateWithAnimation(context, EditUserProfile());
//                                         }, icon: Icon(Iconsax.edit))
//                                       ],
//                                     ))
//                               ]
